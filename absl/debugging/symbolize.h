...
/// }
///
/// @param argv0 Path of the running program, typically `argv[0]` from `main()`.
...
///  }
///
/// @param pc Program counter (instruction pointer value) to symbolize.
/// @param out Buffer to receive the demangled symbol name.
/// @param out_size Size, in bytes, of the `out` buffer.
/// @return True on success, false if the program counter could not be symbolized.

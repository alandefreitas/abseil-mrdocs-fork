...
/// points.
///
/// An `UntypedFormatSpec` is specifically used as an argument to
/// `FormatUntyped()`.
///
/// Example:
///
...
class UntypedFormatSpec {
 public:
  ...
  UntypedFormatSpec(const UntypedFormatSpec& other) = delete;
  /// Deleted copy assignment operator.
  ///
  /// @return A reference to this object.
  UntypedFormatSpec& operator=(const UntypedFormatSpec& other) = delete;

  /// Constructs an untyped format spec from a format string.
  ///
 ...
 protected:
  ...
  ///
  /// @param pc The pre-parsed format.
...
/// with '%s'.
///
/// Allows printing of types that have an `operator<<` but no
...
///
/// @param v The streamable value to wrap.
/// @return A wrapper that formats `v` using its stream operator.
template <typename T>
str_format_internal::StreamedWrapper<T> FormatStreamed(const T& v) {
  return str_format_internal::StreamedWrapper<T>(v);
}

/// Safely wraps `StrFormat()` captures of `%n` conversions into an integer
/// value.
///
/// `%n` conversions denote the number of characters written by a formatting
...
class FormatCountCapture {
 public:
  ...
  ///
  /// @param p Pointer to the integer that receives the character count.
...
///
/// The `FormatSpec` type is a variadic class template that is evaluated at
...
/// A class template representing a preparsed `FormatSpec`, with template
/// arguments specifying the conversion characters used within the format
/// string.
///
/// Such characters must be valid format type specifiers, and
...
///
/// Use it as you would `sprintf()`. `StrFormat()` is the
...
/// @return The formatted string, or an empty string on error.
template <typename... Args>
...
/// arguments, returning `*dst` as a convenience for chaining purposes.
///
...
/// @param format The format string.
/// @param args The arguments substituted into the format string.
/// @return A streamable object that writes the formatted output.
template <typename... Args>
...
///
/// This function is functionally equivalent to `std::printf()` (and type-safe);
...
///
/// This function is functionally equivalent to `std::fprintf()` (and type-safe);
...
/// @param format The format string.
/// @param args The arguments substituted into the format string.
/// @return The number of bytes that would have been written, or a negative
///         value on error.
template <typename... Args>
...
/// A type erased wrapper around arbitrary sink objects specifically used as an
/// argument to `Format()`.
///
...
class FormatRawSink {
 public:
  ...
  /// described above.
  ///
  /// @param raw Pointer to the underlying sink object.
...
/// unspecified.
///
/// @param raw_sink The sink that receives the formatted output.
/// @param format The format string.
/// @param args The arguments substituted into the format string.
...
/// `FormatUntyped()`.
///
/// You may construct `FormatArg` by passing
...
///
/// @param raw_sink The sink that receives the formatted output.
/// @param format The untyped format spec.
/// @param args The arguments substituted into the format string.
/// @return `true` on success, `false` on error.
...
class FormatConversionSpec {
 public:
  ...
  ///
  /// @return The precision, or a negative value if precision is unspecified.
...
enum class FormatConversionCharSet : uint64_t {
  /// Accepts the `c` (character) conversion.
  c = str_format_internal::FormatConversionCharToConvInt('c'),
  /// Accepts the `s` (string) conversion.
  s = str_format_internal::FormatConversionCharToConvInt('s'),
  /// Accepts the `d` (signed decimal integer) conversion.
  d = str_format_internal::FormatConversionCharToConvInt('d'),
  /// Accepts the `i` (signed decimal integer) conversion.
  i = str_format_internal::FormatConversionCharToConvInt('i'),
  /// Accepts the `o` (unsigned octal integer) conversion.
  o = str_format_internal::FormatConversionCharToConvInt('o'),
  /// Accepts the `u` (unsigned decimal integer) conversion.
  u = str_format_internal::FormatConversionCharToConvInt('u'),
  /// Accepts the `x` (unsigned hexadecimal integer) conversion.
  x = str_format_internal::FormatConversionCharToConvInt('x'),
  /// Accepts the `X` (unsigned hexadecimal integer, uppercase) conversion.
  X = str_format_internal::FormatConversionCharToConvInt('X'),
  /// Accepts the `f` (decimal floating-point) conversion.
  f = str_format_internal::FormatConversionCharToConvInt('f'),
  /// Accepts the `F` (decimal floating-point, uppercase) conversion.
  F = str_format_internal::FormatConversionCharToConvInt('F'),
  /// Accepts the `e` (exponential floating-point) conversion.
  e = str_format_internal::FormatConversionCharToConvInt('e'),
  /// Accepts the `E` (exponential floating-point, uppercase) conversion.
  E = str_format_internal::FormatConversionCharToConvInt('E'),
  /// Accepts the `g` (general floating-point) conversion.
  g = str_format_internal::FormatConversionCharToConvInt('g'),
  /// Accepts the `G` (general floating-point, uppercase) conversion.
  G = str_format_internal::FormatConversionCharToConvInt('G'),
  /// Accepts the `a` (hexadecimal floating-point) conversion.
  a = str_format_internal::FormatConversionCharToConvInt('a'),
  /// Accepts the `A` (hexadecimal floating-point, uppercase) conversion.
  A = str_format_internal::FormatConversionCharToConvInt('A'),
  /// Accepts the `n` (character-count) conversion.
  n = str_format_internal::FormatConversionCharToConvInt('n'),
  /// Accepts the `p` (pointer) conversion.
  p = str_format_internal::FormatConversionCharToConvInt('p'),
  /// Accepts the `v` (default-for-deduced-type) conversion.
...
/// A generic abstraction to which conversions may write their formatted string
/// data.
///
...
class FormatSink {
 public:
  ...
  ///
  /// @param v The characters to append.
  /// @param width The minimum number of bytes to append.
  /// @param precision The number of bytes of `v` to append.
  /// @param left Whether padding is added after (`true`) or before (`false`).

 ...
 public:
  ...
  class param_type {
   public:
    ...
    /// Constructs the parameter set from the distribution parameters.
    ///
    ...
    ///
    /// @param k The largest value the distribution can produce.
    /// @param q The exponent parameter of the distribution.
    /// @param v The offset parameter of the distribution.
